...
module.exports = {
    ...
    SESSION: process.env.NIYA_SESSION === undefined ? '' : process.env.NIYA_SESSION,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  ☚⃟፝༄ɴɪʏᴀᴍᴡᴏʟ☚⃟፝࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'NASIF' : process.env.OWNER_SHIP,
    LOGO: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/aqjv8k9.jpeg' : process.env.LOGO_LINK,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ɴɪʏᴀᴍᴡᴏʟ' : process.env.BOTV2_NAME,
    ...
    SUPPORT: "918294555819-1634134075",
    SUPPORT2: "918294555819-1617736751",
    SUPPORT3: "918294555819-1621015274"
};
